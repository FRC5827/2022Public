...
public final class CTREConfigs {
    ...
    public static void setTalonStatusFramePeriod(BaseTalon talon, StatusFrameEnhanced statusFrame, int period, String message) {
        // don't increase CAN status frame period if in simulation, as it doesn't work (causes weird voltage quantization)
    ...
    public static void setTalonControlFramePeriod(BaseTalon talon, ControlFrame controlFrame, int period, String message) {
        // don't increase CAN status frame period if in simulation, as it doesn't work (causes weird voltage quantization)
        if (RobotBase.isSimulation()) {
            return;
        }
    ...
    public static void setCANCoderStatusFramePeriod(CANCoder canCoder, CANCoderStatusFrame statusFrame, int period, String message) {
        // don't increase CAN status frame period if in simulation, as it doesn't work (causes weird voltage quantization)
        if (RobotBase.isSimulation()) {
            return;
        }
